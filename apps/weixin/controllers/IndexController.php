...
class IndexController extends ControllerBase
{
    ...
    {
        // http://yoox.rice5.com.cn/weixin/index/index
        die('index');
    }
    ...
    {
        // http://yoox.rice5.com.cn/weixin/index/callback
        try {
            /**
             * ==================================================================================
             * ====================================以下逻辑请勿修改===================================
    ...
    {
        // http://yoox.rice5.com.cn/weixin/index/syncmenu
        try {
    ...
    {
        // http://yoox.rice5.com.cn/weixin/index/syncconditionalmenu
        try {
    ...
    {
        // http://yoox.rice5.com.cn/weixin/index/createqrcode
        try {
    ...
    {
        // http://yoox.rice5.com.cn/weixin/index/sendtemplatemsg
        try {
    ...
    {
        // http://yoox.rice5.com.cn/weixin/index/getsettings
        try {
    ...
    {
        // http://yoox.rice5.com.cn/weixin/index/getjssdkinfo?url=urlencode(xxx)
        try {
            // 如果不是跨域请求的话
    ...
    {
        // http://yoox.rice5.com.cn/weixin/index/getaccesstoken
        try {
            if (empty($this->_appConfig)) {
                $this->_appConfig = $this->_app->getTokenByAppid($this->appid);
            }
    ...
    {
        // http://yoox.rice5.com.cn/weixin/index/getjsapiticket
        try {
            if (empty($this->_appConfig)) {
                $this->_appConfig = $this->_app->getTokenByAppid($this->appid);
            }
    ...
    {
        // http://yoox.rice5.com.cn/weixin/index/getcallbackip
        try {
            if (empty($this->_appConfig)) {
                $this->_appConfig = $this->_app->getTokenByAppid($this->appid);
            }
    ...
    {
        // http://yoox.rice5.com.cn/weixin/index/getuserinfo?FromUserName=o4ELSvz-B4_DThF0Vpfrverk3IpY
        try {
